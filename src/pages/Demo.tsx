...
export default function Demo() {
  ...
  return (
    <PageLayout>
      ...
      {/* Section 2 - Why This Demo Matters (Competitor Table) */}
      <section className="py-16 bg-gradient-to-b from-[#0B0F14] to-[#131920]">
        <div className="container mx-auto px-6">
          <motion.div {...fadeInUp} className="mb-10">
            <div className="text-xs font-bold text-[#33CCFF] tracking-wider mb-2">02 — WHY THIS DEMO MATTERS</div>
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
              Because Citi currently has no in-app credit intelligence layer.
            </h2>
            <p className="text-gray-400">
              This demo shows the precise capability competitors already use to intercept Citi customers.
            </p>
          </motion.div>

          {/* Competitor Comparison Table */}
          <motion.div {...fadeInUp}>
            <Card className="bg-[#111821] border-[#1E2833] overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-[#1E2833]">
                      <th className="px-4 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-wider">Bank</th>
                      <th className="px-4 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-wider">Consumer Credit Layer</th>
                      <th className="px-4 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-wider">Business Credit Layer</th>
                      <th className="px-4 py-4 text-center text-xs font-bold text-gray-400 uppercase tracking-wider">In-App Prequal</th>
                      <th className="px-4 py-4 text-center text-xs font-bold text-gray-400 uppercase tracking-wider">Predictive Pathways</th>
                    </tr>
                  </thead>
                  <tbody>
                    {competitorData.map((row, idx) => (
                      <tr 
                        key={idx} 
                        className={`border-b border-[#1E2833] ${row.bank === 'Citi' ? 'bg-[#E31837]/10' : ''}`}
                      >
                        <td className={`px-4 py-4 text-sm font-semibold ${row.bank === 'Citi' ? 'text-[#E31837]' : 'text-white'}`}>
                          {row.bank}
                        </td>
                        <td className="px-4 py-4 text-sm">
                          {row.consumer ? (
                            <span className="text-[#33CCFF]">{row.consumer}</span>
                          ) : (
                        ...
                        <td className="px-4 py-4 text-sm">
                          {row.business === true ? (
                            ...
                            <span className="text-gray-400 text-xs">{row.business}</span>
                          ) : (
                            <span className="flex items-center gap-1 text-[#E31837]">
                              <XCircle className="h-4 w-4" /> None
                            </span>
                        ...
                        <td className="px-4 py-4 text-center">
                          {row.prequal ? (
                            ...
                            <XCircle className="h-4 w-4 text-[#E31837] mx-auto" />
                          )}
                        </td>
                        <td className="px-4 py-4 text-center">
                          {row.pathways ? (
          ...
          <motion.div {...fadeInUp} className="mt-8">
            <Card className="bg-gradient-to-r from-[#003B70] to-[#002850] border-[#33CCFF]/30">
              <CardContent className="p-6 text-center">
                <p className="text-white text-lg">
                  This demo shows Citi jumping from <span className="text-[#E31837] font-bold">"No capability"</span> → <span className="text-[#33CCFF] font-bold">"Industry leader"</span> in a single integrated deployment.
                </p>
              </CardContent>
            </Card>
          </motion.div>
      ...
      {/* Section 3 & 4 - Consumer & Business Demo Details */}
