              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
                    <li><strong>Citibank Hosted:</strong> Platform deployed entirely within Citibank's controlled infrastructure</li>
                    <li><strong>Segregated VPC:</strong> Dedicated virtual private cloud with Citibank-approved network controls</li>
                    <li><strong>Hybrid:</strong> Models and analytics in vendor environment; all sensitive data remains in Citibank systems</li>
                  </ul>
                </div>
                <div>
