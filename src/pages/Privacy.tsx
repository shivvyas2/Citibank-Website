            ...
            <Card>
              ...
              <CardContent className="prose prose-sm max-w-none">
                <p className="text-muted-foreground">
                  This Privacy Policy describes how LUMIQ AI and FuteurCredX ("we", "us", or "our") collect, use, and protect information in connection with the Citibank Business Credit Intelligence demonstration and pilot program.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Our platform is SOC 2 Type II compliant and follows ISO 27001 standards. Data can be deployed within financial institution's own infrastructure or in a segregated vendor VPC with Citibank-approved security controls.
                  </p>
                </div>
                <div>
