          ...
          >
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  By accessing or using the Citibank Business Credit Intelligence demonstration site and related LUMIQ AI services (collectively, the "Services"), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the Services.
                </p>
                <p className="text-muted-foreground mt-4">
                  This demonstration site is intended for evaluation purposes by Citibank and authorized representatives. Production deployment and pilot programs are governed by separate Master Service Agreements.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-4">
                  "LUMIQ AI", "FuteurCredX", and associated logos are trademarks of FuteurCredX. Citibank trademarks are used with permission solely for demonstration purposes.
                </p>
              </CardContent>
            </Card>
